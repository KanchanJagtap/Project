...
export const VIOLATIONS: Violation[] = [
  {
    ...
    fine: 1000,
    status: 'pending',
    evidenceDesc: 'Vehicle crossed the stop line after the signal turned red.',
  },
  {
    id: 'VIO-2026002',
    plate: 'MH14CD5678',
    ...
    status: 'processing',
    speed: 87,
    evidenceDesc: 'Vehicle detected travelling above the permitted speed limit.',
  },
  {
    id: 'VIO-2026003',
    plate: 'MH15EF9012',
    ...
    evidenceDesc: 'Commercial vehicle detected occupying an incorrect traffic lane.',
  },
  {
    id: 'VIO-2026004',
    plate: 'MH16GH3456',
    ...
    fine: 500,
    status: 'pending',
    evidenceDesc: 'Two-wheeler rider detected without a helmet.',
  },
  {
    id: 'VIO-2026005',
    plate: 'MH17JK7890',
    ...
    fine: 500,
    status: 'paid',
    evidenceDesc: 'Vehicle detected stationary inside a designated no-parking zone.',
  },
  {
    id: 'VIO-2026006',
    plate: 'MH18LM2468',
    ...
    fine: 2000,
    status: 'processing',
    evidenceDesc: 'Commercial vehicle entered a restricted traffic zone.',
  },
  {
    id: 'VIO-2026007',
    plate: 'MH16GH3456',
    ...
    fine: 1000,
    status: 'pending',
    evidenceDesc: 'Three persons detected travelling on a two-wheeler.',
  },
  {
    id: 'VIO-2026008',
    plate: 'MH12AB1234',
    ...
    fine: 500,
    status: 'challan_issued',
    evidenceDesc: 'Vehicle detected crossing the marked stop line during a red signal.',
  },
  {
    id: 'VIO-2026009',
    plate: 'MH14CD5678',
    ...
    fine: 5000,
    status: 'pending',
    evidenceDesc: 'Vehicle detected travelling against the designated traffic flow.',
  },
  {
    id: 'VIO-2026010',
    plate: 'MH15EF9012',
    ...
    fine: 5000,
    status: 'processing',
    evidenceDesc: 'Number plate appears partially obscured or potentially tampered.',
  },
  {
    id: 'VIO-2026011',
    plate: 'MH17JK7890',
  ...
  },
  {
    ...
    cameraId: 'CAM-45',
    junctionId: 'J12',
    junctionName: 'Pimpri Chowk',
    timestamp: minutesAgo(55),
    confidence: 84,
    fine: 500,
    status: 'pending',
    evidenceDesc: 'Bus detected occupying an incorrect lane near the junction.',
  },
];
