...
export default function Overview({ onNavigate }: OverviewProps) {
  ...
  const aiInsights = [
    { icon: '🔴', text: 'Shivajinagar Junction: High congestion detected on the north approach — AI extending green time for queue clearance.', time: '1m ago', severity: 'critical' },
    { icon: '🟡', text: 'Hadapsar Junction: Traffic pressure rising on the east approach — adaptive signal mode recommended.', time: '3m ago', severity: 'high' },
    { icon: '🟢', text: 'Swargate Junction: Signal optimization reduced average waiting pressure during the current cycle.', time: '5m ago', severity: 'info' },
    { icon: '🔴', text: 'Sion Junction: Heavy traffic pressure detected — adaptive control is preparing additional green time.', time: '7m ago', severity: 'high' },
    { icon: '🟡', text: 'CBS Junction: Queue forming on the south approach — AI recommending a lane-specific green extension.', time: '9m ago', severity: 'medium' },
  ];
