...
class VehicleTrackResponse(ORMModel):
    ...
    camera_name: Optional[str] = Field(None, description="Physical name of the camera if available")
    junction_id: Optional[str] = Field(None, description="Junction ID if camera belongs to an approach")
    junction_name: Optional[str] = Field(None, description="Junction name if camera belongs to an approach")
